  ...
  return (
    ...
    >
      <Link to={`/product/${product.id}`}>
        <div className="rounded-lg border bg-slate-800/50 text-card-foreground shadow-sm backdrop-blur-sm border-slate-700/50 text-white overflow-hidden group transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 hover:-translate-y-1">
