      ...
      {isCartOpen && (
        ...
        >
          <motion.div
            ...
            className="absolute right-0 top-0 h-full w-full max-w-md bg-slate-900/80 backdrop-blur-xl shadow-2xl flex flex-col"
          ...
          >
            ...
            <div className="flex-grow p-6 overflow-y-auto space-y-4">
              {cartItems.length === 0 ? (
                ...
                cartItems.map(item => (
                  <div key={item.variant.id} className="flex items-center gap-4 bg-slate-800/50 p-3 rounded-lg">
